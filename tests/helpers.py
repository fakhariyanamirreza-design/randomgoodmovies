    ...
    return {
        ...
        "scoring": {
            "weights": {
                ...
                "genre_diversity": 0.09,
                "director_diversity": 0.09,
                "era_diversity": 0.09,
                "popularity": 0.05,
                "surprise": 0.07,
                "trending": 0.05,
        ...
        "angles": {
            "priority": [
                ...
                "influential_film", "weekend_recommendation", "decade_recommendation",
                "genre_recommendation", "mood_based",
            ],
            "rules": {
                "trending_now": {},
                "release_anniversary": {},
                ...
                "weekend_recommendation": {"min_rating": 7.5, "weekend_days": [4, 5]},
                "decade_recommendation": {"min_rating": 7.8},
                "genre_recommendation": {"min_rating": 7.8},
                "mood_based": {"min_rating": 7.5, "genres": [35, 10749, 10751, 16]},
            },
        ...
        "content": {
            ...
            "templates": {
                ...
                "weekend_recommendation": [
                    "title_fa", "title_en", "blank", "weekend_line", "tagline",
                    "trending_line", "occasion_line",
                    "blank", "category", "rating", "genres", "runtime", "country",
                    "blank", "director_fa", "director_en", "blank", "overview",
                    "blank", "similar_movies", "blank", "imdb_link", "audience_line",
                    "trailer_line", "blank", "footer",
                ...
                "mood_based": [
                    "title_fa", "title_en", "blank", "mood_line", "tagline",
                    "trending_line", "occasion_line",
                    "blank", "category", "rating", "genres", "runtime", "country",
                    "blank", "director_fa", "director_en", "blank", "overview",
                    "blank", "similar_movies", "blank", "imdb_link", "audience_line",
