...
Rotation           → هر اجرا فقط یک نوع پست: صبح نقل‌قول، شب فیلم
...
tests/                   # ۱۲۲ تست unittest (بدون نیاز به شبکه)
...
| era_diversity | 0.10 | تعادل دهه‌ها |
| popularity | 0.06 | جذابیت برای مخاطب (با سیری پذیری) |
| surprise | 0.04 | کیفیت بالا ولی کمتر شناخته‌شده |
| trending | 0.05 | «ترند روز» بودن در TMDb (هم‌پوشانی با حال‌وهوای روز) |
| classic | 0.06 | بونس صریح به فیلم‌های قدیمی (جبران سلطه‌ی فیلم‌های به‌روز) |
...
روتاسیون، تریلر داخل کپشن) با ۱۲۲ تست بدون نیاز به شبکه پوشش داده شده‌اند.
