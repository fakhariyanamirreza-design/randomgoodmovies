...
Trailer in Caption → لینک خام تریلر یوتیوب داخل کپشن معرفی فیلم (پخش inline)
...
- بلاک `trailer_line` («🎬 تماشای تریلر:») با **لینک خام یوتیوب** رندر می‌شود؛ تلگرام به‌صورت
  خودکار یک کارت ویدیوی **قابل پخش inline** داخل همان پیام می‌سازد.
